      ...
      <ScrollView>
        <View style={styles.container}>
          <ImageBackground source={lingrad} style={styles.background}>
            <Text style={styles.header} className="font-bold p-1 pl-2 pr-2 ">
              ReferHer
            </Text>
          </ImageBackground>
          <Text style={styles.subheader} className="font-semibold">
            Hi-tech Internal Referral Network For Women
          </Text>
          <Image source={referherhome} style={{ width: 300, height: 300 }} />

          <Text className="p-4 color-referwhite text-2xl ">
        ...
        <View style={styles.second_container}>
          <Text style={styles.subheader} className="font-semibold">
            Easy to find a job with ReferHer
          </Text>
        ...
        <View style={styles.third_container}>
          <ImageBackground source={lingrad} style={styles.background}>
            <Text style={styles.second_header} className="font-bold p-1">
              Why ReferHer?
            </Text>
          </ImageBackground>

          <Text style={styles.second_text} className="font-semibold">
        ...
        <View style={styles.fourth_container}>
          <ImageBackground source={lingrad} style={styles.background}>
            <Text style={styles.second_header} className="font-semibold">
              How It Works
            </Text>
          </ImageBackground>
